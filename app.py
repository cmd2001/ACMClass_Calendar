...
def convertTask(x):
    ret = 'BEGIN:VEVENT\n'
    ret = ret + 'DTSTART:TZID=Asia/Shanghai:' + x[0] + convertDigit(x[1]) + convertDigit(x[2]) + 'T' + convertDigit(x[5].split(':')[0]) + convertDigit(x[5].split(':')[1]) + '00\n'
    ret = ret + 'DTDTEND:TZID=Asia/Shanghai:' + x[0] + convertDigit(x[1]) + convertDigit(x[2]) + 'T' + convertDigit(x[6].split(':')[0]) + convertDigit(x[6].split(':')[1]) + '00\n'
    ret = ret + 'SUMMARY:' + x[3] + '\n'
